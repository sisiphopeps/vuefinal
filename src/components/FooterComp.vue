<template>
  <footer class="text-center text-white" style="background-color:#A27459;">
    <!-- Grid container -->
    ...
    <!-- Copyright -->
    <div class="text-center text-dark p-2" style="background-color:#A27459;">
      <span>Email:sisiphopepengweni@gmail.com</span><br>
      © 2023 Copyright:
      <span>Sisipho Pepengweni</span>
    </div>
    <!-- Copyright -->
  </footer>
</template>
